AI Tools Used
ChatGPT (GPT-5) - For debugging 
Cursor - For planning a to-do
Used as a development assistant for architecture planning, implementation guidance, code review, edge-case identification, and basic UX improvements, debugging.
...
“There is a glitch happening between the pages. i think one of my states is not being handled well. I am uplaoding the states and where they are being called, telll me the possible issue for this one”
